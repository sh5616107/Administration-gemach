...
export async function runPendingMigrations(): Promise<void> {
  ...
  // Note: Migration v17 was removed - לא מתקנים סטטוס הלוואות אוטומטית
  // כי יש כללים עסקיים שאוסרים על המעבר active → planned.
  // הלוואות עם אי-עקביות (loan_date עתידי + status=active) יישארו כך
  // עד שיטופלו ידנית או שה-scheduler יפעיל אותן.

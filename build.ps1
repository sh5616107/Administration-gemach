...
if ($LASTEXITCODE -eq 0) {
    ...
    $source = "src-tauri\target\release\bundle\nsis\gemach-manager_4.0.4_x64-setup.exe"
    $dest = "release\gemach-manager_4.0.4_x64-setup.exe"
    ...
    Write-Host "  - gemach-manager_4.0.4_x64-setup.exe (Installer)" -ForegroundColor White

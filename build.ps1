...
if ($LASTEXITCODE -eq 0) {
    ...
    $source = "src-tauri\target\release\bundle\nsis\gemach-manager_3.9.10_x64-setup.exe"
    $dest = "release\gemach-manager_3.9.10_x64-setup.exe"
    ...
    Write-Host "  - gemach-manager_3.9.10_x64-setup.exe (Installer)" -ForegroundColor White
